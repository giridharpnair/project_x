...
`,
	...
	l = n(),
	u = c(),
	d = `` + new URL(`./upi-DcVXD4Z1.png`, import.meta.url).href,
	f = e((e) => {
		var t = Symbol.for(`react.transitional.element`);
		function n(e, n, r) {
			var i = null;
	...
	h = [
		...
		`> verifying identity signature: VALID`,
		`> loading party protocol v3.1.4...`,
		`> access level: GUEST_ELITE`,
	...
	g = {
		...
		time: `19:00`,
		location: `THE MARAKASSERY ANCHORAGE`,
		dresscode: `You're coming to get shit-faced. Look good`,
	};
function _({ text: e, className: t = ``, tag: n = `span` }) {
	...
	return (
		...
		(0, p.jsx)(n, {
			className: `glitch-wrap ${t}`,
			"data-text": e,
			children: (0, p.jsx)(`span`, {
				className: r ? `glitching` : ``,
				children: e,
			}),
		})
	);
...
function v() {
	return (0, p.jsx)(`div`, { className: `scanlines`, "aria-hidden": `true` });
}
function y() {
			...
			(0, p.jsxs)(`div`, {
				...
				children: [
					(0, p.jsxs)(`div`, {
						...
						children: [
							(0, p.jsx)(`span`, { className: `dot red` }),
							(0, p.jsx)(`span`, { className: `dot yellow` }),
							(0, p.jsx)(`span`, { className: `dot green` }),
							(0, p.jsx)(`span`, {
								className: `terminal-title`,
								children: `SECURE_ACCESS.exe`,
							}),
						],
					}),
					(0, p.jsxs)(`div`, {
						...
						children: [
							(0, p.jsxs)(`div`, {
								...
								children: [
									...
									(0, p.jsx)(`p`, {
										children: `> AWAITING CLEARANCE CODE...`,
									}),
								],
							}),
							(0, p.jsx)(_, {
							...
							!a &&
								(0, p.jsx)(`p`, {
									className: `hint-msg`,
									children: `> enter access code to proceed`,
								}),
						],
					}),
				],
			...
			children: [
				...
				(0, p.jsxs)(`div`, {
					...
					children: [
						...
						(0, p.jsxs)(`div`, {
							className: `terminal-body loader-body`,
							children: [
								t.map((e, t) =>
									(0, p.jsx)(
										`p`,
								...
								r &&
									(0, p.jsx)(`p`, {
										...
										children: `> INVITATION LOADED. WELCOME.`,
									}),
							],
						}),
					],
	...
	return (0, p.jsxs)(`div`, {
		...
		children: [
			...
			(0, p.jsxs)(`div`, {
				...
				children: [
					(0, p.jsx)(`span`, {
						className: `qr-fallback-icon`,
						children: `▣`,
					}),
					(0, p.jsx)(`span`, {
						className: `qr-fallback-text`,
						children: `QR_CODE.png`,
					}),
				],
			}),
		],
...
function S() {
	...
	return (
		...
		(0, p.jsxs)(`div`, {
			className: `screen invite-screen ${e ? `fade-in` : ``}`,
			children: [
				(0, p.jsx)(v, {}),
				(0, p.jsx)(`div`, {
					...
					children: (0, p.jsxs)(`div`, {
						...
						children: [
							(0, p.jsxs)(`div`, {
								...
								children: [
									(0, p.jsx)(`p`, {
										className: `invite-sys-tag`,
										children: `> CLASSIFIED TRANSMISSION`,
									}),
									(0, p.jsx)(_, {
									...
									(0, p.jsx)(_, {
										text: `PROJECT X`,
										tag: `h1`,
										className: `invite-title-red`,
									}),
									(0, p.jsx)(_, {
										text: `By Giridhar, Swaraj, Sreeram, GP and Regium`,
										tag: `p`,
										className: `detail-value`,
									}),
									(0, p.jsx)(`div`, { className: `divider` }),
								],
							}),
							(0, p.jsxs)(`div`, {
								...
								children: [
									...
									(0, p.jsxs)(`div`, {
										...
										children: [
											...
											(0, p.jsx)(`a`, {
												href: `https://maps.app.goo.gl/u1ieDKvDMhJ7ymoK6?g_st=iw`,
												target: `_blank`,
								...
								children: [
									...
									(0, p.jsxs)(`p`, {
										...
										children: [
											...
											(0, p.jsx)(`br`, {}),
											`Scan to join the fun - ₹1000 per head, and any extra contribution from our dear seniors will be welcomed with open arms. Kindly consider this a last bout of love from your side and show you generousity as seniors`,
										],
									}),
								],
							}),
							...
							(0, p.jsxs)(`div`, {
								...
								children: [
									(0, p.jsx)(`span`, {
										className: `detail-label-red`,
										children: `While we intend to party hard, please note the following:`,
									}),
									(0, p.jsx)(`span`, {
										className: `detail-value`,
									}),
									(0, p.jsxs)(`ul`, {
										children: [
											(0, p.jsx)(`li`, {
												children: (0, p.jsx)(`span`, {
													className: `detail-value`,
													children: `Carrying / sale of any illicit or illegal substances will not be tolerated`,
												}),
											}),
											(0, p.jsx)(`br`, {}),
											(0, p.jsx)(`li`, {
												children: (0, p.jsx)(`span`, {
													className: `detail-value`,
													children: `Considering that it's a working day and Airbnb restrictions, we are sorry to inform that we discourage sleeping at the venue. Kindly take this into consideration while making your plans`,
												}),
											}),
										],
									}),
							...
							(0, p.jsxs)(`div`, {
								...
								children: [
									(0, p.jsx)(`p`, {
										children: `// THIS INVITATION SELF-DESTRUCTS AFTER THE EVENT //`,
									}),
									(0, p.jsx)(`p`, {
										children: `// DO NOT SHARE — YOU WERE CHOSEN //`,
									}),
								],
							}),
						],
...
function C() {
	...
	return (0, p.jsxs)(`div`, {
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .terminal-title { margin-left: 8px; font-size: 12px; color: rgba(0,255,65,0.5); letter-spacing: 0.12em; }

        .terminal-body {
          background: rgba(0,10,3,0.96);
          border: 1px solid var(--border);
        ...
        .code-center { width: 100%; max-width: 560px; }
        .boot-lines p { font-size: 13px; color: rgba(0,255,65,0.45); line-height: 1.8; letter-spacing: 0.05em; }
        ...
        .glitching { animation: glitch-anim 0.15s steps(2) forwards; }
        @keyframes glitch-anim {
          0%   { text-shadow: 2px 0 var(--red), -2px 0 #0ff; clip-path: inset(40% 0 60% 0); }
          25%  { text-shadow: -3px 0 var(--red), 3px 0 #0ff; clip-path: inset(10% 0 80% 0); transform: translateX(-3px); }
          50%  { text-shadow: 3px 0 var(--red), -3px 0 #0ff; clip-path: inset(70% 0 20% 0); transform: translateX(3px); }
          75%  { text-shadow: -2px 0 #0ff, 2px 0 var(--red); clip-path: inset(30% 0 50% 0); transform: translateX(0); }
        ...
        .input-row:focus-within { box-shadow: 0 0 12px rgba(0,255,65,0.25); }
        .prompt { color: var(--green); font-size: 18px; flex-shrink: 0; }

        .code-input {
          flex: 1; background: none; border: none; outline: none;
          color: var(--green); font-family: var(--font-display);
          font-size: 32px; letter-spacing: 0.25em;
          caret-color: var(--green); width: 100%; text-transform: uppercase;
        }
        .code-input::placeholder { color: rgba(0,255,65,0.2); letter-spacing: 0.3em; }
        ...
        .submit-btn {
          ...
          transition: background 0.2s, box-shadow 0.2s, color 0.2s; border-radius: 3px;
        }
        ...
        .error-msg { color: var(--red); font-size: 13px; margin-top: 14px; letter-spacing: 0.05em; }
        .hint-msg { color: rgba(0,255,65,0.35); font-size: 13px; margin-top: 14px; }
        .success-msg { color: var(--amber); font-size: 13px; margin-top: 14px; letter-spacing: 0.05em; }
        ...
        .terminal-loader { width: 100%; max-width: 640px; }
        .loader-body { min-height: 280px; }
        .terminal-line { font-size: 14px; line-height: 2; color: rgba(0,255,65,0.8); animation: type-in 0.2s ease forwards; }
        @keyframes type-in {
          from { opacity: 0; transform: translateY(4px); }
          to   { opacity: 1; transform: none; }
        }
        .success-line { color: var(--amber); margin-top: 8px; }
        .cursor { display: inline-block; color: var(--green); font-size: 18px; }

        .invite-screen {
          background: var(--bg); justify-content: flex-start;
          padding: 0; opacity: 0; transition: opacity 0.8s ease; min-height: 100vh;
        }
        .invite-screen.fade-in { opacity: 1; }
        .invite-scroll {
          width: 100%; overflow-y: auto;
          padding: 2rem 1rem 4rem;
          display: flex; justify-content: center;
        }
        .invite-inner { width: 100%; max-width: 600px; }

        .invite-header { margin-bottom: 2rem; }
        .invite-sys-tag { font-size: 12px; color: rgba(0,255,65,0.4); letter-spacing: 0.15em; margin-bottom: 12px; }
        .invite-title {
          font-family: var(--font-display);
  ...
  text-shadow: 0 0 30px rgba(255,34,68,0.5) !important;
  display: block;
  letter-spacing: 0.04em;
}

.invite-title-red span {
  color: var(--red) !important;
}
...
.detail-label-red {
  ...
  letter-spacing: 0.2em;
        ...
        .invite-subtitle {
          ...
          color: var(--green-dim); display: block;
          letter-spacing: 0.1em; line-height: 1; margin-top: 4px;
        }
        ...
        .divider::before {
          ...
          color: rgba(0,255,65,0.25); font-size: 12px;
        }

        .details-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 20px; }
        .detail-block { display: flex; flex-direction: column; gap: 4px; }
        .detail-block.full { grid-column: 1 / -1; }
        .detail-label { font-size: 11px; color: rgba(0,255,65,0.35); letter-spacing: 0.2em; }
        .detail-value {
          font-family: var(--font-display); font-size: 28px;
		  text-align: center;
          color: var(--green); letter-spacing: 0.06em; line-height: 1.1;
          text-shadow: 0 0 10px rgba(0,255,65,0.3);
        }
        .detail-sub { font-size: 12px; color: rgba(0,255,65,0.5); letter-spacing: 0.05em; margin-top: 2px; }

        .qr-section { text-align: center; }
        .section-label { font-size: 12px; color: rgba(0,255,65,0.4); letter-spacing: 0.2em; margin-bottom: 20px; text-align: left; }
        ...
        .qr-fallback-icon { font-size: 52px; line-height: 1; }
        .qr-fallback-text { font-size: 11px; letter-spacing: 0.12em; }

        .qr-caption {
          font-family: var(--font-display); font-size: 22px;
          color: var(--green); letter-spacing: 0.08em;
          text-shadow: 0 0 10px rgba(0,255,65,0.3); margin-bottom: 4px;
        }
        .qr-sub { font-size: 11px; color: rgba(0,255,65,0.35); letter-spacing: 0.15em; }

        .rsvp-desc { font-size: 13px; color: rgba(0,255,65,0.6); margin-bottom: 16px; letter-spacing: 0.04em; }
        .rsvp-form { display: flex; flex-direction: column; gap: 12px; }
        .rsvp-input-row {
          display: flex; align-items: center;
          border: 1px solid var(--border); padding: 10px 16px;
          border-radius: 3px; background: rgba(0,255,65,0.03);
        }
        .rsvp-input-row:focus-within { border-color: var(--green); box-shadow: 0 0 10px rgba(0,255,65,0.2); }
        .rsvp-input {
          flex: 1; background: none; border: none; outline: none;
          color: var(--green); font-family: var(--font-mono);
          font-size: 15px; letter-spacing: 0.05em; caret-color: var(--green);
        }
        .rsvp-input::placeholder { color: rgba(0,255,65,0.2); }
        .rsvp-input:disabled { opacity: 0.5; }
        .rsvp-btn { margin-top: 4px; }

        .invite-footer { margin-top: 48px; padding-top: 20px; border-top: 1px solid rgba(0,255,65,0.1); }
        .invite-footer p { font-size: 11px; color: rgba(0,255,65,0.2); letter-spacing: 0.12em; line-height: 2; text-align: center; }
        ...
        @media (max-width: 480px) {
          ...
          .enter-code-title { font-size: 44px; }
        }
      `,
			}),
			e === `code` && (0, p.jsx)(b, { onSuccess: () => t(`loading`) }),
			e === `loading` && (0, p.jsx)(x, { onDone: () => t(`invite`) }),
			e === `invite` && (0, p.jsx)(S, {}),
		],
	});
}
(0, u.createRoot)(document.getElementById(`root`)).render(
	(0, p.jsx)(l.StrictMode, { children: (0, p.jsx)(C, {}) }),
);
